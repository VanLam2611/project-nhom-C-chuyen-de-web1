            ...
            <div class="row">
                <div class="col-md-5">
                    <div class="info-left">
                        ...
                        <img src="<?php echo e(asset('')); ?>frontend/images/<?php echo e($hotel[0]->image); ?>" class="img-fluid" alt="">
                        <h3>Name hotel</h3>
                        <div class="time-rent">
                                            ...
                                            <nav class="choose-payment">
                                                <div class="nav nav-pills nav-underline mb-3 animated"
                                                    ...
                                                    <a href="#token" class="nav-item nav-link" id="token-tab"
                                                        ...
                                                        role="tab">
                                                        <img src="<?php echo e(asset('')); ?>frontend/images/vn-pay.png" alt="VN Pay" class="img-fluid"
                                                    ...
                                                    <div id="ico-accordion" class="collapse-icon accordion-icon-rotate">
                                                        <div class="card">
                                                            <div class="credit-card-item">
                                                                <img src="<?php echo e(asset('')); ?>frontend/images/visa-mastercard.png" alt="Master card"
                                                                    class="img-fluid" width="150px" height="35px">
...
<?php echo $__env->make('frontend.index-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ASUS\Music\project-nhom-C-chuyen-de-web1\project-web1\resources\views/frontend/layout/payment.blade.php ENDPATH**/ ?>